"""
Django settings for cineswipe_backend project.
...
ALLOWED_HOSTS = ['localhost', 'cineswipe-backend-7d577091d70c.herokuapp.com']
...
ROOT_URLCONF = 'cineswipe_backend.urls'
...
WSGI_APPLICATION = 'cineswipe_backend.wsgi.application'


ASGI_APPLICATION = 'cineswipe_backend.asgi.application'
